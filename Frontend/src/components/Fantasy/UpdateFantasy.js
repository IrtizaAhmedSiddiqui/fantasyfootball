...
export default function UpdateFantasy({
  updateFantasyData,
  updateModalSetting,
  handlePageUpdate,
  players,
}) {
  const { user_id, team_name, player_ids } = updateFantasyData;
  ...
  const [fantasy, setFantasy] = useState({
    user_id: user_id,
    team_name: team_name,
    player_id1: player_ids[0].player_id,
    player_id2: player_ids[1].player_id,
    player_id3: player_ids[2].player_id,
    player_id4: player_ids[3].player_id,
    player_id5: player_ids[4].player_id,
    player_id6: player_ids[5].player_id,
    player_id7: player_ids[6].player_id,
    player_id8: player_ids[7].player_id,
    player_id9: player_ids[8].player_id,
    player_id10: player_ids[9].player_id,
    player_id11: player_ids[10].player_id,
  });
  ...
  const updateFantasy = () => {
    ...
    fetch(`http://localhost:8800/fantasy/update-team`, {
