...
export default function UpdateTeam({
  ...
  const { team_id, team_name, stadium_name, manager_id, owner, budget } =
    updateTeamData;
  ...
  const updateTeam = () => {
    ...
    console.log("Team object being sent:", team);

    // API call to update team
    fetch(`http://localhost:8800/team/${team.team_id}`, {
      method: "PUT", // Use PUT method with team ID in the URL
      headers: {
      ...
      .catch((err) => {
        ...
        if (
          ...
          alert("An error occurred while updating the team."); // Generic error
        }
      });
  };
